 ...
 * generated in the com.ramselabs.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.ramselabs.com/", "getServerNameResponse");
    private final static QName _GetServerName_QNAME = new QName("http://ws.ramselabs.com/", "getServerName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ramselabs.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ramselabs.com/", name = "getServerNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ramselabs.com/", name = "getServerName")
