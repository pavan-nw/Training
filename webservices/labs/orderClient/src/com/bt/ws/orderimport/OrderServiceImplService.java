 ...
 * 
 */
@WebServiceClient(name = "OrderServiceImplService", targetNamespace = "http://order.ws.bt.com/", wsdlLocation = "http://localhost:8888/orders?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICEIMPLSERVICE_QNAME = new QName("http://order.ws.bt.com/", "OrderServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/orders?wsdl");
    ...
    public OrderService getOrderServiceImplPort() {
        return super.getPort(new QName("http://order.ws.bt.com/", "OrderServiceImplPort"), OrderService.class);
    }
    ...
    public OrderService getOrderServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://order.ws.bt.com/", "OrderServiceImplPort"), OrderService.class, features);
    }
