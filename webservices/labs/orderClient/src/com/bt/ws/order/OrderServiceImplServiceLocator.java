...
public class OrderServiceImplServiceLocator extends org.apache.axis.client.Service implements com.bt.ws.order.OrderServiceImplService {
    ...
    private java.lang.String OrderServiceImplPort_address = "http://localhost:8888/orders";
    ...
    public com.bt.ws.order.OrderService getOrderServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.bt.ws.order.OrderService getOrderServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bt.ws.order.OrderServiceImplPortBindingStub _stub = new com.bt.ws.order.OrderServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bt.ws.order.OrderService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bt.ws.order.OrderServiceImplPortBindingStub _stub = new com.bt.ws.order.OrderServiceImplPortBindingStub(new java.net.URL(OrderServiceImplPort_address), this);
                _stub.setPortName(getOrderServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://order.ws.bt.com/", "OrderServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://order.ws.bt.com/", "OrderServiceImplPort"));
        }
